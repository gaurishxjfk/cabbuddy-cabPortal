...
import heroImgClient from "@/public/assets/carHero.svg";
import CabBenefits from "./CabBenefits";
  ...
  return (
    <>
      ...
      <section id="hero" className="flex flex-col md:flex-row">
        ...
        >
          <div className="text-center md:text-left max-w-[25em] md:max-w-none mt-12">
            <h1 className="text-3xl md:text-4xl font-bold text-darkText">
              Unlock the Earning Potential of Your Car by Joining Our Network
            </h1>
            <p className="text-gray-600">
              Join us and effortlessly transform your car into a lucrative asset
              and start earning income on your terms.
            </p>
          </div>
        ...
        <div className="absolute bg-opacity-10 z-0 md:relative transform -scale-x-100 md:-mt-2 md:ml-20">
      ...
      <footer className="bg-white w-full text-darkText text-center font-bold py-8">
        <h4 className="text-xl">Join CabBuddy and be part of another success stories</h4>
        <button
